...
public class Lab6 extends GLJPanel implements GLEventListener  {
	...
	public void display(GLAutoDrawable drawable) {    
		...
		int hexagon_edges  = 17; //hexagon
		double increment = 2 * Math.PI/hexagon_edges;
		double angle =0;
		int radius =6;
		float x =0;
		float z = 0;

		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_AMBIENT, materials[12], 0);
		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_DIFFUSE, materials[12], 4 );
		gl2.glMaterialfv( GL2.GL_FRONT_AND_BACK, GL2.GL_SPECULAR, materials[12], 8 );
		gl2.glMaterialf( GL2.GL_FRONT_AND_BACK, GL2.GL_SHININESS, materials[12][12] );

		for (int i = 1; i <= hexagon_edges; i++) {
